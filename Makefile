...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Wed May 25 22:48:25 2011
# Project:  4med.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		gui/ShowDrugs.cpp \
		gui/ShowRegistrations.cpp moc_MainWindow.cpp \
		moc_AddDrug.cpp \
...
$(TARGET): ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h ui_AddRegistration.h ui_ShowRecipients.h ui_ShowDrugs.h ui_ShowRegistrations.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/4med1.0.0/ && $(COPY_FILE) --parents gui/MainWindow.h gui/AddDrug.h gui/AddDepartment.h lib/DrugModel.h lib/DepartmentModel.h lib/DefaultModel.h lib/Db.h lib/RecipientModel.h gui/AddRecipient.h gui/AddRegistration.h lib/RegistrationModel.h gui/ShowRecipients.h gui/ShowDrugs.h gui/ShowRegistrations.h .tmp/4med1.0.0/ && $(COPY_FILE) --parents main.cpp gui/MainWindow.cpp gui/AddDrug.cpp gui/AddDepartment.cpp lib/DrugModel.cpp lib/DepartmentModel.cpp lib/Db.cpp lib/RecipientModel.cpp gui/AddRecipient.cpp gui/AddRegistration.cpp lib/RegistrationModel.cpp gui/ShowRecipients.cpp gui/ShowDrugs.cpp gui/ShowRegistrations.cpp .tmp/4med1.0.0/ && $(COPY_FILE) --parents ui/MainWindow.ui ui/AddDrug.ui ui/AddDepartment.ui ui/AddRecipient.ui ui/AddRegistration.ui ui/ShowRecipients.ui ui/ShowDrugs.ui ui/ShowRegistrations.ui .tmp/4med1.0.0/ && (cd `dirname .tmp/4med1.0.0` && $(TAR) 4med1.0.0.tar 4med1.0.0 && $(COMPRESS) 4med1.0.0.tar) && $(MOVE) `dirname .tmp/4med1.0.0`/4med1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/4med1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_AddDrug.cpp moc_AddDepartment.cpp moc_AddRecipient.cpp moc_AddRegistration.cpp moc_ShowRecipients.cpp moc_ShowDrugs.cpp moc_ShowRegistrations.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_AddDrug.cpp moc_AddDepartment.cpp moc_AddRecipient.cpp moc_AddRegistration.cpp moc_ShowRecipients.cpp moc_ShowDrugs.cpp moc_ShowRegistrations.cpp
...
moc_ShowRegistrations.cpp: gui/ShowRegistrations.h
	/usr/bin/moc $(DEFINES) $(INCPATH) gui/ShowRegistrations.h -o moc_ShowRegistrations.cpp
...
compiler_uic_make_all: ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h ui_AddRegistration.h ui_ShowRecipients.h ui_ShowDrugs.h ui_ShowRegistrations.h
compiler_uic_clean:
	-$(DEL_FILE) ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h ui_AddRegistration.h ui_ShowRecipients.h ui_ShowDrugs.h ui_ShowRegistrations.h
...
ui_ShowRegistrations.h: ui/ShowRegistrations.ui
	/usr/bin/uic ui/ShowRegistrations.ui -o ui_ShowRegistrations.h
...
ShowRegistrations.o: gui/ShowRegistrations.cpp gui/ShowRegistrations.h \
		ui_ShowRegistrations.h \
		lib/RegistrationModel.h \
		lib/DefaultModel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ShowRegistrations.o gui/ShowRegistrations.cpp
...
moc_ShowRegistrations.o: moc_ShowRegistrations.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ShowRegistrations.o moc_ShowRegistrations.cpp
