...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Wed May 18 11:28:11 2011
# Project:  4med.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile 4med.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_TESTLIB_LIB -DQT_SQL_LIB -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
...
SOURCES       = main.cpp \
		...
		gui/AddRecipient.cpp moc_MainWindow.cpp \
		moc_AddDrug.cpp \
...
$(TARGET): ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/4med1.0.0/ && $(COPY_FILE) --parents gui/MainWindow.h gui/AddDrug.h gui/AddDepartment.h lib/DrugModel.h lib/DepartmentModel.h lib/DefaultModel.h lib/Db.h lib/RecipientModel.h gui/AddRecipient.h .tmp/4med1.0.0/ && $(COPY_FILE) --parents main.cpp gui/MainWindow.cpp gui/AddDrug.cpp gui/AddDepartment.cpp lib/DrugModel.cpp lib/DepartmentModel.cpp lib/Db.cpp lib/RecipientModel.cpp gui/AddRecipient.cpp .tmp/4med1.0.0/ && $(COPY_FILE) --parents ui/MainWindow.ui ui/AddDrug.ui ui/AddDepartment.ui ui/AddRecipient.ui .tmp/4med1.0.0/ && (cd `dirname .tmp/4med1.0.0` && $(TAR) 4med1.0.0.tar 4med1.0.0 && $(COMPRESS) 4med1.0.0.tar) && $(MOVE) `dirname .tmp/4med1.0.0`/4med1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/4med1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_AddDrug.cpp moc_AddDepartment.cpp moc_AddRecipient.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_AddDrug.cpp moc_AddDepartment.cpp moc_AddRecipient.cpp
...
compiler_uic_make_all: ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h
compiler_uic_clean:
	-$(DEL_FILE) ui_MainWindow.h ui_AddDrug.h ui_AddDepartment.h ui_AddRecipient.h
